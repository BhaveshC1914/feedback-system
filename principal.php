...
if(isset($_POST['change_password'])){
	...
	if ($o_passwd != '' and $n_passwd != '' and $p_password == $o_passwd) {
			$sql = "UPDATE `principal_details` SET `p_password`='$n_passwd' WHERE p_name='$p_name'";
						...
						<div class="container">
							<div class="row">
								...
								<form id="contact-form" action="principal.php" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            <input type="text" style="margin-top:15px;" name="hod_name" placeholder="Full name of HOD" class="form-control br-radius-zero" autocomplete="off">
										</div>
										<div class="col-md-12 form-group">
                                        ...
                                        <div class="col-md-12 form-group">
                                            <input type="text" name="hod_username" placeholder="Set username" class="form-control br-radius-zero" autocomplete="off">
                                        </div>
                                        <div class="col-md-12 form-group">
                                            <input type="text" name="hod_pwd" placeholder="Set password" class="form-control br-radius-zero" autocomplete="off">
                                        </div>
								...
								<form id="contact-form" action="principal.php" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-12 form-group">
											<input type="text" style="margin-top:15px;" name="old_password" placeholder="enter old password" class="form-control br-radius-zero">
                                        </div>
										<div class="col-md-12 form-group">
											<input type="text" style="margin-top:15px;" name="new_password" placeholder="enter new password" class="form-control br-radius-zero">
                                        </div>
                                        <div class="col-md-12 form-action">
